...
def stem_helper(text):
    ...
    tokenized_words = [stemmer.stem(word) for word in tokenized_words if word not in stop_words]
...
class knn_classifer():  
    ...
    def predict(self, x_test):
        ...
        # method = 1
        # distances = cosine_similarity(x_test, self.training)
        method = 0 
...
def main():
    ...
    vectorizer = TfidfVectorizer(max_df = 0.85, max_features = 10000, tokenizer = stem_helper, lowercase = False)
    ...
    # k_tests(training_vectors, train_data)
